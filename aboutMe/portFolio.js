...
changeColorCV = () => {
  setTimeout(() => (cv.innerText = "M_"), 500);
  setTimeout(() => (cv.innerText = "Mu_"), 1000);
  setTimeout(() => (cv.innerText = "Muk_"), 1500);
  setTimeout(() => (cv.innerText = "Muku_"), 2000);
  setTimeout(() => (cv.innerText = "Mukul_"), 2500);

  setTimeout(() => (cv.innerText = "_"), 4000);

  setTimeout(() => (cv.innerText = "d_"), 4500);
  setTimeout(() => (cv.innerText = "de_"), 5000);
  setTimeout(() => (cv.innerText = "dev_"), 5500);
  setTimeout(() => (cv.innerText = "deve_"), 6000);
  setTimeout(() => (cv.innerText = "devel_"), 6500);
  setTimeout(() => (cv.innerText = "develo_"), 7000);
  setTimeout(() => (cv.innerText = "develop_"), 7500);
  setTimeout(() => (cv.innerText = "develope_"), 8000);
  setTimeout(() => (cv.innerText = "developer_"), 8500);
};
